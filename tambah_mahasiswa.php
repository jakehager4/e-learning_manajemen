			...
			<th>
				<div>
					<form action="" method="POST">
						<h5>NIM</h5>
						<input type="number" name = "txt_nim" placeholder = "Masukan NIM Dosen">
					</div>
				</th>
				<th>
					<div>
						<h5>Nama Mahasiswa</h5>
						<input type="text" name = "txt_nama" placeholder = "Masukan Nama Mahasiswa">
					</div>
				</th>
				<br>
				<br>
				...
				<th>
					<div>
						<h5>Prodi</h5>
						<input type="text" name = "txt_prodi" placeholder = "Masukan Prodi">
					</div>
				</th>
				<th>
					<div>
