...
$data = mysqli_fetch_object($mahasiswa);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$sql = "UPDATE mahasiswa SET nama_mahasiswa = '$nama' , prodi = '$prodi' WHERE nim = $nim;";
			...
			<th>
				<div>
					<form action="" method="POST">
						<h5>NIM</h5>
						<input type="text" name = "txt_nim" placeholder = "Masukan NIM" value="<?= $data->nim ?>">
					</div>
				</th>
				<th>
					<div>
						<h5>Nama Mahasiswa</h5>
						<input type="text" name = "txt_nama" placeholder = "Masukan Nama Mahasiswa" value="<?= $data->nama_mahasiswa ?>">
					</div>
				</th>
				<br>
				<br>
				...
				<th>
					<h5>Prodi</h5>
					<input type="text" name = "txt_prodi" placeholder = "Masukan Prodi" value="<?= $data->prodi ?>">
				</th>
				<th>
					<div>
