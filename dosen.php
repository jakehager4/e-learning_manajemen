...
if (isset($_POST['kata_kunci'])) {
	...
	$sql="select * from dosen where nip like '%".$kata_kunci."%' or nama_dosen like '%".$kata_kunci."%' or alamat like '%".$kata_kunci."%' order by nip asc";
					...
					<td>
						...
						<td>
							...
							<td>
								<?= $data->alamat ?></td>
								<td>
									<a href="edit_dosen.php?id=<?= $data->nip ?>">Ubah</a> |
									<a href="hapus_dosen.php?id=<?= $data->nip ?>"onclick="javascript: return confirm('Anda yakin hapus ?')">Hapus</a>
								</td>
							</tr>
						<?php } ?>
