...
$id = $_GET['id'];
$sql = "SELECT * FROM kelas WHERE kd_kelas = $id";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$sql = "UPDATE kelas SET nama_kelas = '$namak' , deskripsi_kelas = '$deskripsi' WHERE kd_kelas = $kdk;";
			...
			<th>
				<div>
					<form action="" method="POST">
						<h5>Kode Kelas</h5>
						<input type="text" name = "txt_kdk" placeholder = "Masukan Kode Kelas" value="<?= $data->kd_kelas ?>">
					</div>
				</th>
				<th>
					<div>
						<h5>Nama Kelas</h5>
						<input type="text" name = "txt_namak" placeholder = "Masukan Nama Kelas" value="<?= $data->nama_kelas ?>">
					</div>
				</th>
				<br>
				<br>
				...
				<th>
					<div>
						<h5>Deskripsi</h5>
						<textarea type ="text" name="txt_deskripsi" rows="5" placeholder = "Masukan Deskripsi"><?= $data->deskripsi_kelas ?></textarea>
					</div>
				</th>
				<th>
					<div>
