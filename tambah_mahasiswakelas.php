...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$kdk = $_POST['txt_kdk'];
	$nim = $_POST['txt_nim'];
	$sql = "INSERT into mahasiswa_kelas Values ('$id' , '$kdk' , '$nim')";
			...
			<th>
				<div>
					<form action="" method="POST">
						<h5>ID</h5>
						<input type="number" name = "txt_id" placeholder = "Masukan ID">
					</div>
				</th>
				<th>
					<div>
				...
				<th>
					<div>
						<h5>NIM Mahasiswa</h5>
						<input type="number" name = "txt_nim" placeholder = "Masukan NIM Mahasiswa">
					</div>
				</th>
				<th>
					<div>
