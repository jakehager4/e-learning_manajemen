...
$id = $_GET['id'];
$sql = "SELECT * FROM mahasiswa_kelas WHERE id = $id";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$kdk = $_POST['txt_kdk'];
	$nim = $_POST['txt_nim'];
	$sql = "UPDATE mahasiswa_kelas SET kd_kelas = '$kdk' , nim_mahasiswa = '$nim'  WHERE id = $id;";
		...
		<tr>
			<th>
				...
				<th>
					<div>
						<h5>NIM Mahasiswa</h5>
						<input type="number" name = "txt_nim" placeholder = "Masukan NIM Mahasiswa" value="<?= $data->nim_mahasiswa ?>">
					</div>
				</th>
				<br>
				<br>
				...
				<th>
					<div>
						...
						<br>
						<br>
						<a href="mahasiswa_kelas.php">Kembali</a>
					</form>
				</th>
			</table>
		</main>
