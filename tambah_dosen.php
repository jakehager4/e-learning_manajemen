			...
			<th>
				<div>
					<form action="" method="POST">
						<h5>NIP</h5>
						<input type="number" name = "txt_nip" placeholder = "Masukan NIP Dosen">
					</div>
				</th>
				<th>
					<div>
						<h5>Nama Dosen</h5>
						<input type="text" name = "txt_nama" placeholder = "Masukan Nama Dosen">
					</div>
				</th>
				<br>
				<br>
				...
				<th>
					<div>
						<h5>Alamat</h5>
						<textarea type ="text" name="txt_alamat" rows="5" placeholder = "Masukan Alamat"></textarea>
					</div>
				</th>
				<th>
					<div>
