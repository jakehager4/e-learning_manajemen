...
if (isset($_POST['kata_kunci'])) {
	...
	$sql="select * from kelas where kd_kelas like '%".$kata_kunci."%' or nama_kelas like '%".$kata_kunci."%' or deskripsi_kelas like '%".$kata_kunci."%' order by kd_kelas asc";
			...
			<tr>
				<td>
					...
					<td>
						<?= $data->nama_kelas ?></td>
						<td>
							<?= $data->deskripsi_kelas ?></td>
							<td>
								<a href="edit_kelas.php?id=<?= $data->kd_kelas ?>">Ubah</a> |
								<a href="hapus_kelas.php?id=<?= $data->kd_kelas ?>"onclick="javascript: return confirm('Anda yakin hapus ?')">Hapus</a>
							</td>
						</tr>
					<?php } ?>
				</table>
